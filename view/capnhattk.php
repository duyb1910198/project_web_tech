...
<div class="container">
        <div class="book-container">
            <div class="book-box-login">
                <h1 class="title-login bg-dark text-white">Cập Nhật Tài Khoản</h1>
                ...
                <form id="form-register" method="post" action="index.php?act=capnhattk&id=<?=$id_user?>" enctype="multipart/form-data">
                    ...
                    <input type="submit" value="Cập nhật" name="capnhat" class="btn btn-secondary">
                        <?php if($rule=='admin'){ ?>
