      ...
      <div class="container">
          ...
          <div class="col-sm-6 d-flex">
            <div class="book-search-group">
              <form action="index.php?act=sanpham" method="post">
                <input type="text" name="kyw" placeholder="Bạn muốn tìm truyện, danh mục">
        ...
        <div class="book-subnav">
          <ul class="nav justify-content-center">
            ...
            <li class="nav-item">
              <a class="nav-link text-success <?php if($_GET['act'] == 'listsp') echo 'text-danger'?>" href="index.php?act=listsp">Truyện</a>
            </li>
            <li class="nav-item">
